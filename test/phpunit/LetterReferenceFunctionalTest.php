...
/**
 * \file    test/functional/LetterReferenceFunctionalTest.php
...
/**
 * Class LetterReferenceFunctionalTest
 *
 ...
 *
 * @package Testletterreference
 */
class LetterReferenceFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modLetterReference')->click();
		} else {
			// Disable the module
			$this->byHref('modLetterReference')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/letterreference/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('letterreference/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/letterreference/admin/about.php');
		$this->authenticate();
		return $this->assertContains('letterreference/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('letterreferencewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modLetterReference_LetterReferenceTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modLetterReference_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
