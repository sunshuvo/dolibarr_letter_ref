...
/**
 *	\file       letterreference/letterreferenceindex.php
 *	\ingroup    letterreference
 *	\brief      Home page of letterreference top menu
 */
...
$langs->loadLangs(array("letterreference@letterreference"));

$action=GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->letterreference->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("LetterReferenceArea"));

print load_fiche_titre($langs->trans("LetterReferenceArea"), '', 'letterreference.png@letterreference');
...
// Draft MyObject
if (! empty($conf->letterreference->enabled) && $user->rights->letterreference->read)
{
	$langs->load("orders");
