...
/**
 * \file    letterreference/core/boxes/letterreferencewidget1.php
 * \ingroup letterreference
 * \brief   Widget provided by LetterReference
 *
 ...
 */
class letterreferencewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "letterreferencebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "letterreference@letterreference";
	 ...
	 */
	public $depends = array('letterreference');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->letterreference->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/letterreference/class/letterreference.class.php");

		// Populate the head at runtime
		$text = $langs->trans("LetterReferenceBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_letterreference@letterreference',
